...
# Incude Eunoia Branding
include vendor/eunoia/config/version.mk

# Include eunoia Packages
include vendor/eunoia/config/packages.mk
include vendor/prebuilts/prebuilts.mk

# Include Eunoia_props
$(call inherit-product, vendor/eunoia/config/eunoia_props.mk)
